            ...
            <div class="row">
                <div class="col-md-2 sidebar">
					...
					<ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#"><img src="images/inpatient.svg"> Patient</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="col-md-10 offset-md-2">
                    <div class="table-container">
                        <a class="add-button" href="add_users.php"><img src="images/add-circle.svg"> Add User </a>
                        <h2><img src="images/users-group.svg"> Users</h2>
                        ...
                        if(mysqli_num_rows($result) > 0) {
                            ...
                            echo "<thead><tr><th>User ID</th><th>Username</th><th>Password</th><th>User Type</th><th>Actions</th></tr></thead>";
                            echo "<tbody>";
                            while ($row = mysqli_fetch_array($result)) {
                                echo "<tr><td>".$row['user_id']."</td><td>".$row['username']."</td><td>".$row['password']."</td><td>".$row['user_type']."<td><a href='edit_users.php?id=".$row['user_id']."'><i class='edit-button fas fa-edit'></i></a> | <a href='delete_function.php?id=".$row['user_id']."'><i class='delete-button fas fa-trash'></i></a></td></tr>";
                            }
                            ...
                            echo "<div class='alert alert-warning' role='alert' style='text-align: center;'>No users found.</div>";
                        }
